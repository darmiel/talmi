...
func TestHandleIssue(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		require.Len(t, body.Artifacts[0].Covers, 1)
		is.Equal(core.Resource("ghes-corp:acme/x"), body.Artifacts[0].Covers[0].Resource)
		is.Equal([]core.Action{"contents:write"}, body.Artifacts[0].Covers[0].Actions)
