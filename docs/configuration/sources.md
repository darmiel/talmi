...
1. Create a GitHub App with **Contents: read** on the config repository (and **Webhooks** if you want
   push-triggered reloads). Install it on the repo and note the App ID and installation ID.
